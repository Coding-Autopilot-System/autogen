...
| 05-03-03 | 05-03 | 3 | UI-01, UI-02, UI-03 | compile and syntax | `.\.venv\Scripts\python.exe -m compileall maf_starter autogen_dashboard tests main.py` and `node --check autogen_dashboard\static\app.js` | YES | pending |
